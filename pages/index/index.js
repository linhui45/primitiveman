...
Page({
  ...
  onLoad: function(e) {   
    ...
    WxParse.wxParse('article', 'html', shopInfo.introduce, that, 15); 
  },
  onPageScroll(e) {
  ...
  openMap: function (e) {
    var latitude = e.currentTarget.dataset.latitude;//26.03003;
    var longitude = e.currentTarget.dataset.longitude;//119.26124;
    wx.openLocation({
      latitude: latitude,
      longitude: longitude,
      scale: 28
